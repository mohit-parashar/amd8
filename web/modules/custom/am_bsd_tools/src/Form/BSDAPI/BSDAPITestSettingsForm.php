 ...
 */
class BSDAPITestSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function defaultConfiguration() {
    $default_config = \Drupal::config('am_bsd_tools.bsdtestsettings');
    return array(
  ...
  public function getFormId() {
    return 'bsdtestsettings_form';
  }
  /**
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('am_bsd_tools.bsdtestsettings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('am_bsd_tools.bsdtestsettings')
      // Save api key
