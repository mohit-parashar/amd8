...
(function($) {
        ...
        attach: function(context, settings) {
            if (context == document) {
                ...
                function addMonthlyAttribute() {
                    //var mon_amounts = ['20', '50', '100', '250', '500'];
                    var mon_amounts = [];
                ...
                function saveDonorInfo() {
                    ...
                    jQuery.ajax({
                        ...
                        data: {
                            ...
                            choose_designation: 'anniversary-challenge',
    ...
    jQuery('#webform-submission-anniversary-challenge-add-form input[type="text"]').keyup(function() {
