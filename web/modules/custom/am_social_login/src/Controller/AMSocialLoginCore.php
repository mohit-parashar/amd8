...
namespace Drupal\am_social_login\Controller;
 ...
 */
class AMSocialLoginCore extends SocialLoginCore {
              ...
              // No Existing User: Social Login (Default)
                ...
                if (\Drupal::config('user.settings')->get('register') != USER_REGISTER_ADMINISTRATORS_ONLY) {
                  ...
                  if ($registration_method == 'manual') {
                    ...
                    if (!empty($user_email)) {
                      $user_obj = social_login_get_uid_for_email($user_email);
                      $user_obj = reset($user_obj);
                      ...
                      // Error while login.
                      drupal_set_message(t('Error while logging you in, email address does not exists.'), 'error');
                      return new RedirectResponse(\Drupal::url('<front>'));
                    }
                  }
                }
